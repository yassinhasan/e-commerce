            ...
            <div>
                <ul class="notifcation-area">
                    <li class="notification-dropdown user">
                        <a href="#" class="user-name"><?= $user_name ?> <i class="fa fa-chevron-down user-down-icon" aria-hidden="true"></i>
                         </a>
    ...
    <div class="main">
        <div class="sidebar">
                <div class="sidebar-content">
                    <div class="user-info">
                        <img src="/images/user.jpg" alt="image_user">
                        <h5> <?= $user_name ?></h5>
                        <h5 class='user-title'> <?= $user_title ?></h5>
                    </div>
    ...
    <div class="content">
        ...
        <section class="breadcrumb">
            <ul class="breadcrumb-nav">
                <li class="breadcrumb-list"><a href="<?= '/'.$controller_name?> "class="breadcrumb-link first  ?> "> <?= $title?>   
                </a></li>
